/*
14.Write a Java program ‘WordCount’ that counts the words in one or more files.
...
public class WordCount_14 extends Thread
{
    String name;
    
    WordCount_14(String fname)
    {
        this.name=fname;
    }
    ...
    public static void main(String[] args)
    {
        ...
        for(String i:names)
        {
            WordCount_14 wc=new WordCount_14(i);
